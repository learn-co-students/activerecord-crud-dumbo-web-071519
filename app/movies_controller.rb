...
release_date: 1990})
  ...
  # release_date == 1990
  Movie.create do |m|
    #Movie.can_be_created_with_a_hash_of_attributes(args)
...
def can_find_using_where_clause_and_be_sorted
  ...
  #Movie.where(self.release_date > 2000)
  Movie.where("release_date > 2002").order(release_date: :desc)
  #.sort_by {|movie| movie.release_date}.reverse
end
...
def can_update_using_update_method
  ...
  movie = Movie.last.update(title:"Wat, huh?")
  movie
  #return value true, but movie variable gets saved as instance after all?
end
...
def can_update_multiple_items_at_once
  ...
  Movie.all.map {|movie| movie.update(title:"A Movie")}
end
