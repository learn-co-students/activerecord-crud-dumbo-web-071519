...
def can_be_found_updated_and_saved
  ...
  update_needed = Movie.find_by({title:"Awesome Flick"})
  update_needed.title = "Even Awesomer Flick"
  update_needed.save
end
...
def can_update_using_update_method
  ...
  change_title = Movie.find_by(title: "Wat?")
  change_title.update(title: "Wat, huh?")
end
...
def can_destroy_a_single_item
  ...
  to_go = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once")
  to_go.destroy
end
